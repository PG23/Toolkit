This template has been modified by pg23 to serve as a simple "Toolkit" app.  Particular thanks to Mozilla's empty app template, Robnyman's Boilerplate app and Beardfu's Compass app for inspiration.
